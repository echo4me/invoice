								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">Petey koko</h5>
												</div>
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="{{route('MarkAsRead_all')}}">Mark All Read </a>
											</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notification-count">
											عدد الاشعارات غير مقروئة ( {{ auth()->user()->unreadNotifications->count()  }} )
										</p>
									</div>
									...
									<div id="notification-unread">
										...
										<a class="d-flex p-3 border-bottom" href="{{url('InvoicesDetails')}}/{{$notification->data['id']}}">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1" style="position: relative">
