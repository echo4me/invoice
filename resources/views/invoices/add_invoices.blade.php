                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{old('invoice_number')}}" id="inputName" name="invoice_number"
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" value="{{old('Due_date')}}" name="Due_date" placeholder="YYYY-MM-DD"
                                    type="text" required>
                            </div>
...
@section('js')
    ...
    <!-- DatePicker Plugin Code To Work On -->
    <script>
