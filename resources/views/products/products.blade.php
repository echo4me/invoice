                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                            href="#exampleModal">{{ __('invoices.productAdd') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">{{ __('invoices.productName') }}</th>
                                    <th class="border-bottom-0">{{ __('invoices.productNote') }}</th>
                                    <th class="border-bottom-0">{{ __('invoices.productSection') }}</th>
                                    <th class="border-bottom-0">{{ __('invoices.productControl') }}</th>
